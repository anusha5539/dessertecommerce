   ...
   <div class="lg:my-10 my-5">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        @foreach($product as $products)
            <div>
                <img class="lg:h-60 lg:w-72 md:h-80  md:w-96 sm:h-64 sm:w-80 h-fit m-auto w-fit   rounded lg:mt-0 mt-10"  src="/product/{{$products->image}}" alt="Error loading images">   
